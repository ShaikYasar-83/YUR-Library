...
const reviewSchema = new mongoose.Schema(
  {
    ...
    // Who wrote this review (the logged-in user)
    user: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "User",
...
// ─── Unique Constraint: One Review Per User Per Note ──────────────────────────
// This compound index ensures that the combination of (note + user) is unique.
// If the same user tries to review the same note twice,
