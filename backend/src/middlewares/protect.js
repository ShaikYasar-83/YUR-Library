...
// ─────────────────────────────────────────────────────────────────────────────
// getOptionalUser middleware — Identifies user if possible, but doesn't block
//
// Useful for public routes that want to track identity if available (e.g. reviews)
// ─────────────────────────────────────────────────────────────────────────────
const getOptionalUser = async (req, res, next) => {
  ...
  try {
    ...
    // If token is invalid, we just ignore it for optional user
    next();
  }
};

module.exports = { protect, getOptionalUser };
